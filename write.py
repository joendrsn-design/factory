    ...
    def _magpie_build_prompt_base(self, metadata: dict, body: str, site_context: SiteContext) -> tuple[str, str]:
        ...
        if code == "P1":
            ...
            user = (
                ...
                f"a 2-3 sentence bridge to how treatment is guided. State every statistic with its source and "
                f"year. If a figure is not in the data, omit it. End with a numbered References section.\n\n"
